export default function Project() {
  ...
  const projects = [
  {
    ...
    description: "An interactive dashboard analyzing regional sales trends, built to help a small business spot underperforming segments faster.",
  },
  {
    id: 2,
    image: "https://images.unsplash.com/photo-1551650992-ee4fd47df41f?q=80&w=1480&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    name: "Customer Churn Predictor",
    description: "A model that flags customers likely to stop using a service, based on usage patterns and support ticket history.",
  },
  {
    id: 3,
  ...
  return (
    <div className="px-10 py-10">
      <div className="text-center space-y-4">
        <h3 className="text-3xl text-bold">My Projects</h3>
        <p className="text-2xl">What I've been working on ...</p>
      </div>
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
        {projects.map((project) => (
          <div
            key={project.id}
            className="border border-gray-200 dark:border-gray-800 rounded-xl p-6 flex flex-col"
          >
            ...
            <button className="mt-4 self-start px-4 py-2 rounded-lg bg-orange-600 text-white text-sm font-medium hover:bg-orange-700 transition-colors">
              View More
            </button>
          </div>
        ))}
